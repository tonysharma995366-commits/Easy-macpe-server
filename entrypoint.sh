...
Claim karne ke baad bot ko 'done' likhkar bhejein."
        ...
        send_tg "Playit tunnel active. Launching server..."
    fi
    ...
    send_tg "Server Online! Minecraft aur Telegram Bot successfully connect ho chuke hain. Sabhi 41 commands dekhne ke liye /help likhein."
) &
