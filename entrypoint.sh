...
HELP_TEXT = """MCPE Server Master Control Panel (All 41 Options)
...
Merchant & Economy:
4. /spawnmerchant <player> - Spawn pre-programmed trader at player
5. /shop - View all items & prices
6. /shopset <item> <on|off> - Allow/block item in shop
7. /customprice <item> <currency> <price> <count> - Custom price
8. /processbuy <player> <item> - Execute secure trade

Security & Protection:
9. /propertyprotection <on|off> - Anti-Griefing (no block breaks)
10. /chestlock <on|off> - Chest & container protection
11. /antixray <on|off> - Force server texture enforcement

Player Moderation:
12. /players - List online players
13. /op <player> - Grant admin privileges
14. /deop <player> - Revoke admin privileges
15. /kick <player> - Kick player from server
16. /ban <player> - Permanently ban player
17. /unban <player> - Unban player
18. /whitelist <on|off> - Toggle server whitelist
19. /whitelistadd <player> - Add player to whitelist
20. /whitelistremove <player> - Remove from whitelist
21. /tp <player1> <player2> - Teleport player
22. /kill <player> - Kill player
23. /clearinv <player> - Clear player inventory

Gameplay & GameRules:
24. /coords - Show in-game coordinates
25. /keepinventory - Keep inventory on death
26. /pvp <on|off> - Toggle player vs player damage
27. /difficulty <peaceful|easy|normal|hard> - Set difficulty
28. /gamemode <survival|creative|adventure> - Default gamemode
29. /time <day|night|noon|midnight> - Change in-game time
30. /weather <clear|rain|thunder> - Change weather
31. /mobspawning <true|false> - Toggle natural mob spawn
32. /killmobs - Clear all hostile mobs from world
33. /say <message> - Server-wide broadcast announcement

Server Diagnostics & Terminal:
34. /status - Check Minecraft & Playit status
35. /logs - Real-time console log view
36. /fixtunnel - Clean restart Playit tunnel
37. /restart - Restart Bedrock server
38. /startserver - Start server
39. /stopserver - Stop server
40. /cmd <cmd> - Run any Minecraft console command
41. /shell <cmd> - Run Linux terminal bash command
"""

def handle_updates():
    offset = 0
    start_server()
    send_message("Minecraft Server Controller Active!\nType /help to see all 41 commands.")
